...
if("TRUE" STREQUAL "TRUE")
  set(async_web_server_cpp_SOURCE_PREFIX /home/techknowfile/catkin_ws/src/async_web_server_cpp)
  set(async_web_server_cpp_DEVEL_PREFIX /home/techknowfile/catkin_ws/devel)
  ...
  set(async_web_server_cpp_INSTALL_PREFIX /home/techknowfile/catkin_ws/install)
...
if(NOT "/home/techknowfile/catkin_ws/src/async_web_server_cpp/include;/usr/include " STREQUAL " ")
  set(async_web_server_cpp_INCLUDE_DIRS "")
  set(_include_dirs "/home/techknowfile/catkin_ws/src/async_web_server_cpp/include;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'async_web_server_cpp' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/techknowfile/catkin_ws/src/async_web_server_cpp/${idir}'.  Ask the maintainer 'Russell Toris <russell.toris@gmail.com>' to fix it.")
    endif()
    _list_append_unique(async_web_server_cpp_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "async_web_server_cpp;/usr/lib/x86_64-linux-gnu/libboost_thread.so;/usr/lib/x86_64-linux-gnu/libboost_system.so;/usr/lib/x86_64-linux-gnu/libboost_regex.so;/usr/lib/x86_64-linux-gnu/libboost_filesystem.so;/usr/lib/x86_64-linux-gnu/libpthread.so")
